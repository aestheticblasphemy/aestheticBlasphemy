...
class UserProfile(BaseContentClass):
    ...
    def _get_social_account(self,provider=None):
        """
        Return the social account object of Facebook and Google in that order if provier is None else return the provider account.
        """
        if provider != None:
    ...
    def get_avatar_url(self,provider=None):
        """
        Return the avatar of social account Facebook and Google in that order, if provider is None.
    ...
    def get_username(self,provider=None):
        """
        Return the username of social account Facebook and Google in that order, if provider is None.
        todo: return default avatar if no social account is found.
        """
        profile = self._get_social_account(provider)
        if profile != None:
    ...
    def get_first_name(self,provider=None):
        """
        Return the first name from social account Facebook and Google in that order, if provider is None.
    ...
    def get_last_name(self,provider=None):
        """
        Return the last name from social account Facebook and Google in that order, if provider is None.
    ...
    def get_gender(self,provider=None):
        """
        Return the gender from social account Facebook and Google in that order, if provider is None.
        todo: return default last name from User model if no social account is found.
        """
        profile = self._get_social_account(provider)
        if profile != None:
    ...
    def get_email(self,provider=None):
        """
        Return the email of social account Facebook and Google in that order, if provider is None.
        todo: return default email  if no social account is found.
        """
        profile = self._get_social_account(provider)
        if profile != None:
            return profile.extra_data.get('email', None)
        else:
    ...
    def get_social_url(self,provider=None):
        """
        Return the social url of social account Facebook and Google in that order, if provider is None.
    ...
    def get_provider_name(self,provider=None):
        """
        Return the provider name of social account Facebook and Google in that order, if provider is None.
        todo: return default blank  if no social account is found.
        """
        profile = self._get_social_account(provider)
        if profile != None:
    ...
    """
    Private functions for retrieving the fname, lname, email etc. from Google and Facebook 
    """
