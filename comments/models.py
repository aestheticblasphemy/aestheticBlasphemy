...
class Comment(BaseContentClass):
    post = models.ForeignKey(BlogContent, related_name="comments", null=True, on_delete = models.SET_NULL)
    body = models.TextField()

    author = models.ForeignKey(User, related_name="comments",
                               null=True,
                               verbose_name=_("Annotation author"), on_delete = models.SET_NULL)
